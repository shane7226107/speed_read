    ...
    receivedEvent: function(id) {    	
    	...
    	$(function(){
    		...
    		function reset(deleteinput){
    			...
    			window.clearInterval(running_sentences);
    			running_sentences = null;
    		...
    		function pause(){
    			if (running_sentences == null) {   				
    				
    				speed = parseInt($('#speed').val());    				
    				
    				running_sentences = window.setInterval(function(){    				   
